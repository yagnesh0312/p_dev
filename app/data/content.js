...
export default class Content {
    //TODO HOME 
    static PROJECT_TITLE = "DevY_"
    static MEANS_NAME = "Developer Yagnesh"
    ...
    static EDUCATION_DATA = [
        ...
        },
        {
            title: "2023",
            content: (
                degreeCard("Bachelor of Computer Application", "Veer Narmad South Gujarat University, Surat", "2023", "9.29", "With a strong foundation in computer science, I'm ready for the next step in my journey.")
    ...
    static ABOUT_CONTAINER_BORDER_CLASSES = "bg-white dark:bg-black p-6 pt-0 overflow-hidden rounded-1xl shadow-xl transition duration-150 ease-in-out block-card";
    static INSTAGRAM_URL = "https://www.instagram.com/_yagnesh_jariwala_/";

    //TODO PROJECT PAGE

    static PROJECT_HEADER_TITLE = "Latest Creations";
    static PROJECT_HEADER_SUBTITLE = "These are altogether my own creations.";



    //TODO CONTACT PAGE
    static CONTACT_TITLE = "Say Hello!";
