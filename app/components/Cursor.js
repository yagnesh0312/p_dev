        ...
        <>
            ...
            <div
                ...
                style={{
                    ...
                    boxShadow: '0px 0px 50px 2px rgba(16,185,129,0.9)',
            ...
            <div
                className={`absolute z-[600] transition-transform duration-150 ease-out mix-blend-difference cursor-root ${isLinkHovered ? 'bg-green-500 shadow-[0_0_50px_2px_rgb(16,185,129)]' : 'bg-white'}`}
                style={{
