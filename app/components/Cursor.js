    ...
    return (
        <>
            <div
                ...
                style={{
                    transform: `translate3d(${position.x}px, ${position.y}px, ${position.z}px) scale(${isLinkHovered ? 1.2 : 1})`,
                    width: '25px',
                    height: '25px',
                    borderRadius: '50%',
                    backgroundColor: 'rgba(255,255,255,0.3)',
                    boxShadow: '0px 0px 50px 2px rgba(59,130,246,0.5)',
                    filter: 'drop-shadow(0px 0px 50px rgba(59,130,246,0.5))'
                }}
            >
                <div
            ...
            <div
                ...
                style={{
                    transform: `translate3d(${position.x + 15}px, ${position.y + 15}px, ${position.z + 15}px) scale(${isLinkHovered ? 1.25 : 1})`,
                    width: '10px',
                    height: '10px',
                    borderRadius: '50%',
                    backgroundColor: 'rgba(255,255,255,0.3)',
            ...
            <div
                className={`absolute z-[60] transition-transform duration-150 ease-out mix-blend-difference cursor-root ${isLinkHovered ? 'bg-blue-500 shadow-[0_0_50px_2px_rgb(59,130,246)]' : 'bg-white'}`}
                style={{
                    transform: `translate3d(${position.x + 20}px, ${position.y + 20}px, ${position.z + 20}px) scale(${isLinkHovered ? 1.3 : 1})`,
                    width: '10px',
                    height: '10px',
                    borderRadius: '50%',
                    boxShadow: '0px 0px 50px 2px rgba(59,130,246,0.5)',
