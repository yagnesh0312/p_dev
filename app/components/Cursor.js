...
function Cursor() {
    ...
    return (
        <>
            ...
            <div
                className="absolute z-[500] transition-transform duration-1000 ease-out cursor-border"
                style={{
                    ...
                    boxShadow: '0px 0px 50px 2px rgba(159,93,227,0.9)',
                    filter: 'drop-shadow(0px 0px 50px rgba(243,168,131,0.5))'
                }}
            >
                <div
            ...
            <div
                className="absolute z-[505] transition-transform duration-500 ease-out"
                style={{
            ...
            <div
                className={`absolute z-[600] transition-transform duration-150 ease-out mix-blend-difference cursor-root ${isLinkHovered ? 'bg-#ff6ec7 shadow-[0_0_50px_2px_rgb(159,93,227)]' : 'bg-white'}`}
                style={{
